      ...
      <DocsArticle title="Tile(s)" colorIndex="neutral-3">
        ...
        <section>
          ...
          <dl>
            ...
            <dd>Whether to update the number of columns based on the component width.
              Defaults to <code>false</code>. The number of columns can be set with
              <code>numColumns</code>.</dd>
            <dt><code>numColumns  number</code></dt>
            <dd>Number of columns to allow for masonry option, based on component width.
              Responds based on the width of the tile children.</dd>
          </dl>
